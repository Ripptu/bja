  ...
  return (
    <div className="flex flex-col flex-1 w-full text-[#1d1d1f] gap-8 pb-16">
        ...
        <AnimatePresence>
          {filteredServices.map((service) => (
            <motion.div 
              ...
              key={service.id}
              className="bg-white rounded-3xl border border-gray-200/70 p-8 flex flex-col justify-between shadow-lg shadow-black/[0.02] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden"
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="w-12 h-12 rounded-2xl bg-blue-50/80 text-[#002B5B] flex items-center justify-center group-hover:scale-110 group-hover:bg-[#002B5B] group-hover:text-white transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-[#1d1d1f] tracking-tight mb-3 group-hover:text-[#002B5B] transition-colors">
                  {service.title}
                </h3>
      ...
      <motion.div 
        ...
        className="mt-6 bg-[#1d1d1f] text-white rounded-3xl p-8 sm:p-12 md:p-14 border border-gray-800 shadow-2xl relative overflow-hidden"
      >
        ...
        <div className="max-w-4xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 bg-gray-900/80 rounded-2xl p-6 md:p-8 border border-gray-800 backdrop-blur-md">
            <div>
          ...
          {/* Results Bento Box */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-8 bg-white text-[#1d1d1f] rounded-2xl shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:border-l sm:border-gray-200 sm:pl-8">
              ...
              <button
                ...
                className="bg-[#002B5B] text-white px-6 py-3.5 rounded-full text-xs font-semibold hover:bg-[#003d82] transition-all duration-300 shadow-md cursor-pointer whitespace-nowrap"
              >
                Entlastung buchen
              </button>
            </div>
